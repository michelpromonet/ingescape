...
void run_static_tests (int argc, const char * argv[]){
    ...
    assert(igs_service_init("my Service", testerServiceCallback, NULL) == IGS_SUCCESS);
    assert(igs_service_remove("my Service") == IGS_SUCCESS);
    assert(igs_service_remove("my Service") == IGS_FAILURE);
    assert(igs_service_arg_add("my Service", "myArg", IGS_BOOL_T) == IGS_FAILURE);
    assert(igs_service_arg_remove("my Service", "myArg") == IGS_FAILURE);

    assert(igs_service_init("my Service", testerServiceCallback, NULL) == IGS_SUCCESS);
    assert(igs_service_arg_add("my Service", "myBool", IGS_BOOL_T) == IGS_SUCCESS);
    assert(igs_service_arg_add("my Service", "myInt", IGS_INTEGER_T) == IGS_SUCCESS);
    assert(igs_service_arg_add("my Service", "myDouble", IGS_DOUBLE_T) == IGS_SUCCESS);
    assert(igs_service_arg_add("my Service", "myString", IGS_STRING_T) == IGS_SUCCESS);
    assert(igs_service_arg_add("my Service", "myData", IGS_DATA_T) == IGS_SUCCESS);
    assert(igs_service_count() == 1);
    assert(igs_service_exists("my Service"));
    listOfStrings = igs_service_list(&nbElements);
    assert(nbElements == 1 && streq(listOfStrings[0], "my Service"));
    
    assert(igs_service_description("my Service") == NULL);
    assert(igs_service_set_description("unknow", "my Service description") == IGS_FAILURE);
    assert(igs_service_set_description("my Service", "my Service description") == IGS_SUCCESS);
    char * servicedescription = igs_service_description("my Service");
    assert(streq(servicedescription, "my Service description"));
    free(servicedescription);
    
    assert(igs_service_init("my Service2", testerServiceCallback, NULL) == IGS_SUCCESS);
    assert(igs_service_set_description("my Service2", "my Service2 description") == IGS_SUCCESS);
    
    assert(igs_service_arg_description("my Service", "myBool") == NULL);
    assert(igs_service_arg_set_description("unknow", "myBool", "myBool description") == IGS_FAILURE);
    assert(igs_service_arg_set_description("my Service", "unknow", "myBool description") == IGS_FAILURE);
    assert(igs_service_arg_set_description("my Service", "myBool", "myBool description") == IGS_SUCCESS);
    char * serviceArgBoolDescription = igs_service_arg_description("my Service", "myBool");
    assert(streq(serviceArgBoolDescription, "myBool description"));
    free(serviceArgBoolDescription);
    assert(igs_service_arg_description("unknow", "myBool") == NULL);
    assert(igs_service_arg_description("my Service", "unknow") == NULL);
    
    assert(igs_service_arg_description("my Service", "myInt") == NULL);
    assert(igs_service_arg_set_description("unknow", "myInt", "myInt description") == IGS_FAILURE);
    assert(igs_service_arg_set_description("my Service", "unknow", "myInt description") == IGS_FAILURE);
    assert(igs_service_arg_set_description("my Service", "myInt", "myInt description") == IGS_SUCCESS);
    char * serviceArgIntDescription = igs_service_arg_description("my Service", "myInt");
    assert(streq(serviceArgIntDescription, "myInt description"));
    free(serviceArgIntDescription);
    assert(igs_service_arg_description("unknow", "myInt") == NULL);
    assert(igs_service_arg_description("my Service", "unknow") == NULL);
    
    char * currentDefinition = igs_definition_json();
    igs_clear_definition();
    igs_definition_load_str(currentDefinition);
    char * newServiceDescription = igs_service_description("my Service");
    assert(streq(newServiceDescription, "my Service description"));
    free(newServiceDescription);
    char * newService2Description = igs_service_description("my Service2");
    assert(streq(newService2Description, "my Service2 description"));
    free(newService2Description);
    char * newServiceArgBoolDescription = igs_service_arg_description("my Service", "myBool");
    assert(streq(newServiceArgBoolDescription, "myBool description"));
    free(newServiceArgBoolDescription);
    char * newServiceArgIntDescription = igs_service_arg_description("my Service", "myInt");
    assert(streq(newServiceArgIntDescription, "myInt description"));
    free(newServiceArgIntDescription);
    ...
    assert(igs_service_arg_add("my Service", "myString", IGS_STRING_T) == IGS_SUCCESS);
    assert(igs_service_arg_add("my Service", "myData", IGS_DATA_T) == IGS_SUCCESS);
    assert(igs_service_args_count("my Service") == 5);
    assert(igs_service_arg_exists("my Service", "myBool"));
    assert(igs_service_arg_exists("my Service", "myInt"));
    assert(igs_service_arg_exists("my Service", "myDouble"));
    assert(igs_service_arg_exists("my Service", "myString"));
    assert(igs_service_arg_exists("my Service", "myData"));
    list = igs_service_args_first("my Service");
    assert(list);
    ...
    //service with reply
    assert(igs_service_init("my ServiceWithReplies", testerServiceCallback, NULL) == IGS_SUCCESS);
    assert(!igs_service_has_replies("my ServiceWithReplies"));
    assert(!igs_service_has_reply("my ServiceWithReplies", "toto"));
    size_t replies_nb = 0;
    char** names = igs_service_reply_names("my ServiceWithReplies", &replies_nb);
    assert(names == NULL && replies_nb == 0);
    assert(igs_service_reply_args_first("my ServiceWithReplies", "toto") == NULL);
    assert(igs_service_reply_args_count("my ServiceWithReplies", "toto") == 0);
    assert(igs_service_reply_add("my ServiceWithReplies", "myReply") == IGS_SUCCESS);
    assert(igs_service_reply_add("my ServiceWithReplies", "myReply2") == IGS_SUCCESS);
    assert(igs_service_has_replies("my ServiceWithReplies"));
    assert(igs_service_has_reply("my ServiceWithReplies", "myReply"));
    assert(igs_service_has_reply("my ServiceWithReplies", "myReply2"));
    assert(!igs_service_has_reply("my ServiceWithReplies", "myReply3"));
    assert(igs_service_has_replies("my ServiceWithReplies"));
    names = igs_service_reply_names("my ServiceWithReplies", &replies_nb);
    assert(names && replies_nb == 2 && streq("myReply", names[0]) && streq("myReply2", names[1]));
    igs_free_services_list(names, replies_nb);
    
    assert(igs_service_reply_description("my ServiceWithReplies", "myReply") == NULL);
    assert(igs_service_reply_set_description("unknow", "myReply", "my ServiceReply description") == IGS_FAILURE);
    assert(igs_service_reply_set_description("my ServiceWithReplies", "unknow", "my ServiceReply description") == IGS_FAILURE);
    assert(igs_service_reply_set_description("my ServiceWithReplies", "myReply", "my ServiceReply description") == IGS_SUCCESS);
    char * replyDescription = igs_service_reply_description("my ServiceWithReplies", "myReply");
    assert(streq(replyDescription, "my ServiceReply description"));
    free(replyDescription);
    
    assert(igs_service_reply_description("my ServiceWithReplies", "myReply2") == NULL);
    assert(igs_service_reply_set_description("my ServiceWithReplies", "myReply2", "my ServiceReply2 description") == IGS_SUCCESS);
    
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply", "myBool", IGS_BOOL_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_description("my ServiceWithReplies", "myReply", "myBool") == NULL);
    assert(igs_service_reply_arg_set_description("unknow", "myReply", "myBool", "myArgBool description") == IGS_FAILURE);
    assert(igs_service_reply_arg_set_description("my ServiceWithReplies", "unknow", "myBool", "myArgBool description") == IGS_FAILURE);
    assert(igs_service_reply_arg_set_description("my ServiceWithReplies", "myReply", "unknow", "myArgBool description") == IGS_FAILURE);
    assert(igs_service_reply_arg_set_description("my ServiceWithReplies", "myReply", "myBool", "myArgBool description") == IGS_SUCCESS);
    char * replyArgBoolDescription = igs_service_reply_arg_description("my ServiceWithReplies", "myReply", "myBool");
    assert(streq(replyArgBoolDescription, "myArgBool description"));
    free(replyArgBoolDescription);
    
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply", "myInt", IGS_INTEGER_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_description("my ServiceWithReplies", "myReply", "myInt") == NULL);
    assert(igs_service_reply_arg_set_description("unknow", "myReply", "myInt", "myArgInt description") == IGS_FAILURE);
    assert(igs_service_reply_arg_set_description("my ServiceWithReplies", "unknow", "myInt", "myArgInt description") == IGS_FAILURE);
    assert(igs_service_reply_arg_set_description("my ServiceWithReplies", "myReply", "unknow", "myArgInt description") == IGS_FAILURE);
    assert(igs_service_reply_arg_set_description("my ServiceWithReplies", "myReply", "myInt", "myArgInt description") == IGS_SUCCESS);
    char * replyArgIntDescription = igs_service_reply_arg_description("my ServiceWithReplies", "myReply", "myInt");
    assert(streq(replyArgIntDescription, "myArgInt description"));
    free(replyArgIntDescription);
    
    currentDefinition = igs_definition_json();
    igs_clear_definition();
    igs_definition_load_str(currentDefinition);
    char * newReplyDescription = igs_service_reply_description("my ServiceWithReplies", "myReply");
    assert(streq(newReplyDescription, "my ServiceReply description"));
    free(newReplyDescription);
    char * newReply2Description = igs_service_reply_description("my ServiceWithReplies", "myReply2");
    assert(streq(newReply2Description, "my ServiceReply2 description"));
    free(newReply2Description);
    char * newReplyArgBoolDescription = igs_service_reply_arg_description("my ServiceWithReplies", "myReply", "myBool");
    assert(streq(newReplyArgBoolDescription, "myArgBool description"));
    free(newReplyArgBoolDescription);
    char * newReplyArgIntDescription = igs_service_reply_arg_description("my ServiceWithReplies", "myReply", "myInt");
    assert(streq(newReplyArgIntDescription, "myArgInt description"));
    free(newReplyArgIntDescription);
    
    assert(igs_service_reply_arg_set_description("my ServiceWithReplies", "myReply", "myBool", "") == IGS_SUCCESS);
    assert(igs_service_reply_arg_set_description("my ServiceWithReplies", "myReply", "myInt", "") == IGS_SUCCESS);
    igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myBool");
    igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myInt");
    
    assert(igs_service_reply_args_first("my ServiceWithReplies", "myReply") == NULL);
    assert(igs_service_reply_args_count("my ServiceWithReplies", "myReply") == 0);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply", "myBool", IGS_BOOL_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply", "myInt", IGS_INTEGER_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply", "myDouble", IGS_DOUBLE_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply", "myString", IGS_STRING_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply", "myData", IGS_DATA_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply2", "myBool2", IGS_BOOL_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply2", "myInt2", IGS_INTEGER_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply2", "myDouble2", IGS_DOUBLE_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply2", "myString2", IGS_STRING_T) == IGS_SUCCESS);
    assert(igs_service_reply_arg_add("my ServiceWithReplies", "myReply2", "myData2", IGS_DATA_T) == IGS_SUCCESS);
    assert(igs_service_reply_args_first("my ServiceWithReplies", "myReply"));
    assert(igs_service_reply_args_count("my ServiceWithReplies", "myReply") == 5);
    assert(igs_service_reply_args_first("my ServiceWithReplies", "myReply2"));
    assert(igs_service_reply_args_count("my ServiceWithReplies", "myReply2") == 5);
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myBool"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myInt"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myDouble"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myString"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myData"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myBool2"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myInt2"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myDouble2"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myString2"));
    assert(igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myData2"));
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myBool") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myInt") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myDouble") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myString") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myData") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myBool") == IGS_FAILURE);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myInt") == IGS_FAILURE);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myDouble") == IGS_FAILURE);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myString") == IGS_FAILURE);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply", "myData") == IGS_FAILURE);
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myBool"));
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myInt"));
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myDouble"));
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply", "myString"));
    ...
    assert(igs_service_reply_args_count("my ServiceWithReplies", "myReply") == 0);
    assert(igs_service_reply_args_first("my ServiceWithReplies", "myReply") == NULL);
    assert(igs_service_reply_remove("my ServiceWithReplies", "myReply") == IGS_SUCCESS);
    assert(igs_service_reply_remove("my ServiceWithReplies", "myReply") == IGS_FAILURE);
    assert(!igs_service_has_reply("my ServiceWithReplies", "myReply"));
    names = igs_service_reply_names("my ServiceWithReplies", &replies_nb);
    assert(replies_nb == 1 && streq("myReply2", names[0]));
    igs_free_services_list(names, replies_nb);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myBool2") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myInt2") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myDouble2") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myString2") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myData2") == IGS_SUCCESS);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myBool2") == IGS_FAILURE);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myInt2") == IGS_FAILURE);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myDouble2") == IGS_FAILURE);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myString2") == IGS_FAILURE);
    assert(igs_service_reply_arg_remove("my ServiceWithReplies", "myReply2", "myData2") == IGS_FAILURE);
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myBool2"));
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myInt2"));
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myDouble2"));
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myString2"));
    assert(!igs_service_reply_arg_exists("my ServiceWithReplies", "myReply2", "myData2"));
    assert(igs_service_reply_args_count("my ServiceWithReplies", "myReply2") == 0);
    assert(igs_service_reply_args_first("my ServiceWithReplies", "myReply2") == NULL);
    assert(igs_service_has_reply("my ServiceWithReplies", "myReply2"));
    assert(igs_service_reply_remove("my ServiceWithReplies", "myReply2") == IGS_SUCCESS);
    assert(igs_service_reply_remove("my ServiceWithReplies", "myReply2") == IGS_FAILURE);
    assert(!igs_service_has_reply("my ServiceWithReplies", "myReply2"));
    names = igs_service_reply_names("my ServiceWithReplies", &replies_nb);
    assert(names == NULL && replies_nb == 0);
    assert(!igs_service_has_replies("my ServiceWithReplies"));
    ...
    igs_definition_save();
    assert(igs_service_remove("my ServiceWithReplies") == IGS_SUCCESS);
    igs_clear_definition();
    igs_definition_load_file("/tmp/simple Demo Agent.json");
    ...
    igs_service_init("my Service", testerServiceCallback, NULL);
    igs_service_arg_add("my Service", "myBool", IGS_BOOL_T);
    igs_service_arg_add("my Service", "myInt", IGS_INTEGER_T);
    igs_service_arg_add("my Service", "myDouble", IGS_DOUBLE_T);
    igs_service_arg_add("my Service", "myString", IGS_STRING_T);
    igs_service_arg_add("my Service", "myData", IGS_DATA_T);
    ...
    free(readResult);
    assert(igs_input_set_string("my data", "this is a test string") == IGS_SUCCESS); //converted as raw data
    igs_input_data("my data", &data, &dataSize);
    assert(dataSize == strlen("this is a test string") + 1);
    free(data);
    assert(igs_input_set_string("my data", "0123456789abcdef") == IGS_SUCCESS); //parsed as hexadecimal data
    igs_input_data("my data", &data, &dataSize);
    assert(dataSize == 8);
    free(data);
    assert(igs_input_set_string("my data", "") == IGS_SUCCESS);
    igs_input_data("my data", &data, &dataSize);
    assert(dataSize == 1);
    free(data);
    assert(igs_input_set_string("my data", NULL) == IGS_SUCCESS);
    igs_input_data("my data", &data, &dataSize);
    assert(!data && dataSize == 0);
    

    data = (void*)"my raw data";
    dataSize = strlen("my raw data") + 1;
    assert(igs_input_set_data("my impulsion", data, dataSize) == IGS_SUCCESS);
    assert(igs_input_set_data("my bool", data, dataSize) == IGS_FAILURE);
    assert(igs_input_set_data("my int", data, dataSize) == IGS_FAILURE);
    assert(igs_input_set_data("my double", data, dataSize) == IGS_FAILURE);
    assert(igs_input_set_data("my string", data, dataSize) == IGS_SUCCESS);
    char *data_str = igs_input_string("my string");
    assert(streq(data_str, (char *)data));
    free(data_str);
    assert(igs_input_set_data("my data", data, dataSize) == IGS_SUCCESS);
    assert(igs_input_data("my data", &data, &dataSize) == IGS_SUCCESS);
    assert(streq("my raw data", (char*)data) && dataSize == strlen("my raw data") + 1);
    free(data);
    bool myBool = true;
    igs_input_set_bool("my bool", false);
    assert(igs_input_set_data("my bool", &myBool, sizeof(bool)) == IGS_SUCCESS);
    assert(igs_input_bool("my bool"));
    int myInt = 123456;
    igs_input_set_int("my int", 0);
    assert(igs_input_set_data("my int", &myInt, sizeof(int)) == IGS_SUCCESS);
    assert(igs_input_int("my int") == myInt);
    double myDouble = 123.456;
    igs_input_set_double("my double", 0.0);
    assert(igs_input_set_data("my double", &myDouble, sizeof(double)) == IGS_SUCCESS);
    assert(igs_input_double("my double") == myDouble);
    ...
    igs_input_set_string("my string", "");
    readResult = igs_input_string("my string");
    assert(streq(readResult, ""));
    free(readResult);
    igs_input_set_string("my string", NULL);
    readResult = igs_input_string("my string");
    assert(!readResult);
    ...
    free(data);
    igs_input_set_data("my data", "hello", 0);
    assert(igs_input_data("my data", &data, &dataSize) == IGS_SUCCESS && data == NULL && dataSize == 0);
    igs_input_set_data("my data", "", 0);
    assert(igs_input_data("my data", &data, &dataSize) == IGS_SUCCESS && data == NULL && dataSize == 0);
    igs_input_set_data("my data", NULL, 0);
    assert(igs_input_data("my data", &data, &dataSize) == IGS_SUCCESS && data == NULL && dataSize == 0);
